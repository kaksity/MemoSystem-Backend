...
export default function fetchInfrastructureProvider(infrastructureProviderOptions: InfrastructureProviderGeneratorOptionsType): Record<string, string | boolean | any> {
